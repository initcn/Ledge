...
import com.ledge.core.utils.date.DateUtils.currentYear
    ...
    val progress: Float
        get() =
            if (budgetAmount <= 0L) {
                ...
                (spentAmount.toFloat() / budgetAmount.toFloat())
            }
...
class BudgetRepository @Inject constructor(
    ...
    suspend fun saveBudget(
        ...
        val existingBudget =
            ...
            budgetDao.getBudgetForCategory(
